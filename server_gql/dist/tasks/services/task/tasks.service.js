...
let TaskService = class TaskService {
    ...
    async createTask(createTaskInput) {
        const task = await this.taskRepository.save(Object.assign({}, createTaskInput));
        return task;
    }
    async getOneTask(id) {
    ...
    async updateTask(updateTaskInput) {
        await this.taskRepository.update({ id: updateTaskInput.id }, Object.assign({}, updateTaskInput));
